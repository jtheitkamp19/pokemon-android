...
public class ConditionDB
{
    ...
    public static Dictionary<ConditionID, Condition> Conditions {
        get; set;
    } = new Dictionary<ConditionID, Condition> {
        {
            ConditionID.psn, new Condition() {
                ...
                OnAfterTurn = (Pokemon pokemon) => {
                    ...
                    pokemon.StatusChanges.Enqueue($"{pokemon.Base.Name} was hurt by it's poison");
                }
            }
        },
        {
            ConditionID.brn, new Condition() {
                ...
                OnAfterTurn = (Pokemon pokemon) => {
                    ...
                    pokemon.StatusChanges.Enqueue($"{pokemon.Base.Name} was hurt by it's burn");
                }
            }
        },
        {
        ...
        },
        {
            ConditionID.slp, new Condition() {
                ...
                OnStart = (Pokemon pokemon) => {
                    ...
                    Debug.Log($"{pokemon.Base.Name} will sleep for {pokemon.StatusTime} moves");
                },
                OnBeforeMove = (Pokemon pokemon) => {
